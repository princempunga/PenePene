...
<body>
    ...
    <div class="header">
        <div>
            <h1>PenePene</h1>
            <p>Rapport des ventes — <?php echo e($seller->business_name); ?></p>
        </div>
        <div style="text-align: right;">
            <p>Généré le : <?php echo e(now()->locale('fr')->translatedFormat('d M Y H:i')); ?></p>
            <p>Période : <?php echo e($from->locale('fr')->translatedFormat('d M Y')); ?> – <?php echo e($to->locale('fr')->translatedFormat('d M Y')); ?></p>
        </div>
    </div>
    ...
    <div class="meta">
        <div class="summary">
            <div class="summary-card">
                ...
                <p><?php echo e($data->count()); ?></p>
            </div>
            <div class="summary-card">
                <label>Revenus totaux</label>
                <p><?php echo e(number_format($data->sum('total'), 0, ',', ' ')); ?> FC</p>
            </div>
            <div class="summary-card">
                <label>Livrées</label>
                <p><?php echo e($data->where('status', 'delivered')->count()); ?></p>
            </div>
            <div class="summary-card">
                <label>En attente</label>
                <p><?php echo e($data->where('status', 'pending')->count()); ?></p>
            </div>
        </div>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($order->created_at->locale('fr')->translatedFormat('d M Y')); ?></td>
                    <td><?php echo e(optional(optional($order->buyer)->user)->name ?? 'N/D'); ?></td>
                    <td><?php echo e($order->items->count()); ?></td>
                    <td><?php echo e(number_format($order->total_amount, 0, ',', ' ')); ?></td>
                    <td><span class="badge badge-<?php echo e($order->status); ?>"><?php echo e($statusLabels[$order->status] ?? ucfirst($order->status)); ?></span></td>
                </tr>
    ...
    <div class="footer">
        PenePene Marketplace — Rapport vendeur confidentiel — Généré le <?php echo e(now()->locale('fr')->translatedFormat('d M Y')); ?>

    </div>
</body>
</html>
<?php /**PATH C:\Users\Michel\PenePene\resources\views\reports\seller\sales.blade.php ENDPATH**/ ?>