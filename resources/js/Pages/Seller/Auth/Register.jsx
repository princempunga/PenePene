                    ...
                    {step === 2 && (
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <AuthInput id="country" label={t('seller.country')} icon={MapPin} value={data.country} onChange={(e) => setData('country', e.target.value)} error={errors.country} placeholder={t('seller.country_placeholder')} required accent="amber" />
