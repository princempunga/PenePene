...
function formatPlanPrice(plan) {
    ...
    const cycle = plan.billing_cycle === 'monthly' ? 'mois' : plan.billing_cycle === 'yearly' ? 'an' : plan.billing_cycle;
    return `${formatCurrency(plan.price)} / ${cycle}`;
}
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col py-12 px-4">
                <div className="w-full max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="mt-4 text-3xl font-bold text-gray-900">Devenir vendeur</h2>
                        <p className="mt-2 text-gray-500">Touchez des milliers d&apos;acheteurs dès aujourd&apos;hui.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                        <div className="p-8 md:p-10 space-y-8">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 border-b border-gray-100 pb-2 mb-4">1. Informations personnelles</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input type="tel" value={data.phone} onChange={e => setData('phone', e.target.value)} required placeholder="+243…" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary-500 outline-none" />
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 border-b border-gray-100 pb-2 mb-4">2. Informations de la boutique</h3>
                                <div className="space-y-5">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Nom commercial / Nom de la boutique</label>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 border-b border-gray-100 pb-2 mb-4">3. Document de vérification</h3>
                                <p className="text-sm text-gray-500 mb-3">Veuillez téléverser une licence commerciale ou une pièce d&apos;identité nationale valide pour vérification (PDF, JPG, PNG). Max. 5 Mo.</p>
                                ...
                                >
                                    ...
                                    {data.document ? (
                                        ...
                                        <p className="font-medium text-gray-600">Cliquez pour parcourir ou glissez-déposez</p>
                                    )}
                                </div>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 border-b border-gray-100 pb-2 mb-4">4. Choisir un plan</h3>
                        ...
                        <div className="bg-gray-50 p-8 border-t border-gray-100 text-center">
                            ...
                            >
                                {processing ? 'Envoi de la candidature…' : 'Postuler comme vendeur'}
                            </button>
                            <p className="mt-4 text-sm text-gray-500">
                                Vous avez déjà un compte vendeur ? <Link href="/login" className="text-primary-600 font-medium">Se connecter</Link>
                            </p>
                        </div>
                    </form>
                </div>
