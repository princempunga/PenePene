...
export default function AdminLayout({ children, title }) {
    ...
    return (
        <CurrencyProvider>
            {/*
            ┌─────────────────────────────────────────────────────────────────┐
            │  LAYOUT FLUIDE (Sticky Layout)                                  │
            │  On utilise min-h-screen. Le scroll est géré par le navigateur  │
            ...
            */}
            <div className="flex min-h-screen bg-gray-50">
                ...
                ══════════════════════════════════════════════════════════════
                  SIDEBAR
                  • Mobile  : drawer fixe (z-60), glisse depuis la gauche
                  • Desktop : sticky top-0, reste visible pendant le scroll
                ...
                */}
                <aside
                    ...
                    `}
                >
                    {/* ── En-tête drawer (mobile uniquement) ── */}
                    ...
                    <nav className="flex-1 py-2 pb-4">
                        <div className="md:bg-white md:rounded-xl md:border md:border-gray-200 md:shadow-sm md:mx-3 md:overflow-hidden md:flex md:flex-col">
                            ...
                            <Link
                                ...
                                as="button"
                                onClick={closeSidebar}
                                className="w-full flex items-center gap-2.5 px-3 py-3 text-sm font-medium text-red-600 hover:bg-red-50 border-t border-gray-100 transition-colors"
                            >
                ...
                */}
                <div className="flex-1 min-w-0 flex flex-col">
                    ...
                    {/*
                    ── Main Content ────────────────────────────────────────────
                      Le contenu s'étend naturellement. Pas de height fixe.
                ...
                {/* Mobile bottom nav — fixed, hors flux */}
